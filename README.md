...
A token is used to authenticate a user, allowing them to view specific content that pertains to them or access content they normally could not.

- [ ] What steps can you take in your web apps to keep your data secure?

Use private routes, encrypt passwords, protect your api keys!

- [ ] Describe how web servers work.

HTTP, or HyperText Transfer Protocol. As soon as you make a request from your computer, information is exchanged between web servers before being returned and displayed on your local machine.
