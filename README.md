...
A token is used for client-side authentication, allowing a user to access specific content from within our website.

- [ ] What steps can you take in your web apps to keep your data secure?

Using Private Routes, encrypting passwords, and protecting your API keys.

- [ ] Describe how web servers work.

Using Hypertext Transfer Protocol, information is exchanged between web servers as soon as you make a request from your local machine, or computer. That information is then displayed to your web browser.
